...
1. Add the text to be sent in a json object as below:
```javascipt
...
1. Handle that summarized data recieved as needed
1. The data that will sent back to your api that called the middleware should be parsed to a JSON object
#Example
